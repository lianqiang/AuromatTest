...
STATICforIDL Logical InValidDataType (dataType)
Int32 dataType;
{
  switch (dataType) {
    case CDF_INT8: return TRUE;
...
STATICforIDL CDFstatus ValidateCompression (cType, cParms)
long cType;
long *cParms;
{
  switch (cType) {
...
STATICforIDL CDFstatus ValidateCompression64 (cType, cParms)
long cType;
long *cParms;
{
  switch (cType) {
