...
/* Compress from file source to file dest until EOF on source.
   def() returns CDF_OK on success, or ZLIB_COMPRESS_ERROR for any error, .e.g.,
...
/* Decompress from file source to file dest until stream ends or EOF.
   inf() returns CDF_OK on success, or ZLIB_UNCOMPRESS_ERROR for any error,
...
STATICforIDL CDFstatus DecompressGZIP_64 (srcFp, srcOffset, srcError, destFp,
