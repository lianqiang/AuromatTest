...
STATICforIDL Logical ValidAttrName PROTOARGs((char *name));
STATICforIDL Logical ValidDataType PROTOARGs((Int32 dataType));
STATICforIDL Logical InValidDataType PROTOARGs((Int32 dataType));
STATICforIDL Logical ValidAttrScope PROTOARGs((Int32 scope));
STATICforIDL Logical ValidEncoding PROTOARGs((
  Int32 encoding, Int32 *actualEncoding
));
STATICforIDL Logical ValidDecoding PROTOARGs((Int32 decoding));
STATICforIDL CDFstatus ValidateCompression PROTOARGs((
...
STATICforIDL CDFstatus DecompressGZIP PROTOARGs((
  vFILE *srcFp, Int32 srcOffset, CDFstatus srcError, vFILE *destFp,
  Int32 destOffset, CDFstatus destError
));
...
VISIBLE_PREFIX CDFstatus ValidateCDF PROTOARGs((
