...
STATICforIDL CDFstatus ValidateCompression64 PROTOARGs((
...
STATICforIDL CDFstatus DecompressGZIP_64 PROTOARGs((
  vFILE *srcFp, OFF_T srcOffset, CDFstatus srcError, vFILE *destFp,
  OFF_T destOffset, CDFstatus destError
));
...
VISIBLE_PREFIX CDFstatus ValidateCDF64 PROTOARGs((
